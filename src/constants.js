...
export const ITEM_CATEGORY_IMPLANT = "IM";
export const ITEM_CATEGORY_INJECTABLE = "IN";
export const ITEM_CATEGORY_PILL = "P";
export const ITEM_CATEGORY_DIU = "DIU";
export const ITEM_TYPE_MEDICAL_CONSUMABLE = "M";
export const ITEM_TYPES = [ITEM_TYPE_DRUG, ITEM_TYPE_MEDICAL_CONSUMABLE];
export const ITEM_CATEGORIES = [ITEM_CATEGORY_IMPLANT, ITEM_CATEGORY_INJECTABLE, ITEM_CATEGORY_PILL, ITEM_CATEGORY_DIU];
